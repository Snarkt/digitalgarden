...
查看Host為localhost   
![image_e.png](/img/user/img/image_e.png)
...
export CATALINA_PID=/SRM/Helpdesk4J/tomcat9/bin/catalina.pid
...
`cd /SRM/Helpdesk4J`   
`./bin/Startup.sh`   
![image_i.png](/img/user/img/image_i.png)
查看tomcat log服務是否正常   
...
![image_b.png](/img/user/img/image_b.png)
...
![image_a.png](/img/user/img/image_a.png)
需要添加一位全開權限   
aa
aa@a.a
- [ ] 啟用
...
填入API key設定啟用   
![image_4a.png](/img/user/img/image_4a.png)
...
![image_c.png](/img/user/img/image_c.png)
