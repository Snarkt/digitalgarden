...
```
    ...
    <property name="connection.url">jdbc:mariadb://192.168.182.129:3306/WiSe_Robot?autoCommit=true&amp;autoReconnect=true&amp;useUnicode=true&amp;characterEncoding=UTF8</property>
...
```
![image.png](imgae_19.png)    
![image.png](imgae_32.png)    
...
export JAVA_HOME=/SRM/SmartRobot/jdk17
...
JAVA\_HOME=/SRM/SmartRobot/jdk17   
CATALINA\_HOME=/SRM/SmartRobot/tomcat10   
CATALINA\_PID=catalinaPid   
...
export CATALINA_HOME=/SRM/SmartRobot/tomcat10
export CATALINA_BASE=/SRM/SmartRobot/tomcat10
...
依照對應的192.168.182.129:8023 來源core建立公司   
![image_k.png](/img/user/img/image_k.png)    
